...
class Router
{
     ...
     *
     * @var \VinyVicente\JsonRpc\Routing\RouteCollection
     */
    protected $routes;
     ...
     *
     * @var \VinyVicente\JsonRpc\Server\Request
     */
        ...
        return (new Pipeline($this->container))
            ...
            ->then(function ($request) use ($route) {
                return $this->prepareResponse(
                    $request,
                    $route->run((array) $request->getParams())
                );
            });
    }
     ...
     *
     * @return \VinyVicente\JsonRpc\Server\Request
     */
     ...
     *
     * @return \VinyVicente\JsonRpc\Routing\RouteCollection
     */
     ...
     *
     * @param  \VinyVicente\JsonRpc\Routing\RouteCollection $routes
     * @return void
     */
