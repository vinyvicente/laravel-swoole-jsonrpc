...
use VinyVicente\JsonRpc\Exceptions\ConnectionException;
...
class Connection
{
     ...
     * @param string $host
     * @param string $port
     * @throws \VinyVicente\JsonRpc\Exceptions\ConnectionException
     */
     ...
     * @param mixed $id
     * @return \VinyVicente\JsonRpc\Client\Response
     */
