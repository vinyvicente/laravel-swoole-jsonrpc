...
use VinyVicente\JsonRpc\Exceptions\InternalErrorException;
use VinyVicente\JsonRpc\Exceptions\InvalidParamsException;
...
class ResponseFactory
{
     ...
     * @param array|\Illuminate\Support\Collection $collection
     * @param int $total
     * @param \VinyVicente\JsonRpc\Server\Transformable|null $transformer
     * @return \VinyVicente\JsonRpc\Server\Response
     */
